...
export function ControllerStatusPage({ backendChoice, devices, ignoredDevices }: ControllerStatusPageProps) {
  const { t } = useTranslation()

  if (backendChoice === 'legacy') {
    return (
  ...
  return (
    <div className={styles.page}>
      ...
      {devices.map(device => {
        ...
        return (
          <Card key={device.handle} className={styles.deviceCard}>
