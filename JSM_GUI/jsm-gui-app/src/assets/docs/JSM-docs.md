...
* **ONE\_EURO\_MIN\_CUTOFF** (default 6.0) - Minimum cutoff frequency for One Euro filter. Lower this value to reduce slow speed jitter.
* **ONE\_EURO\_SPEED\_COEFF** (default 0.3) - Speed coefficient for One Euro filter. Raise this value to reduce speed lag.
